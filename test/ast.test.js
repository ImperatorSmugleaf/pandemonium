...
const expected = `   1 | Program statements=[#2,#4,#5,#36]
   2 | VariableDeclaration variable=(Id,"oneThroughFive") type=#3 initializer=[(Num,"1"),(Num,"2"),(Num,"3"),(Num,"4"),(Num,"5")]
   3 | List type=(Sym,"num")
   4 | VariableDeclaration variable=(Id,"counting") type=(Sym,"bool") initializer=(Bool,"true")
   5 | ProcedureDeclaration proc=(Id,"main") params=[#6] body=#8
   6 | Parameter type=#7 id=(Id,"args")
   7 | List type=(Sym,"string")
   8 | Block statements=[#9,#10,#17,#18,#19,#21,#32,#35]
   9 | VariableDeclaration variable=(Id,"count") type=(Sym,"num") initializer=(Num,"0")
  ...
  39 | VariableDeclaration variable=(Id,"triple") type=(Sym,"num") initializer=#40
