...
const semanticChecks = [
    ...
    ["struct declaration", "struct S {string g; num f() {return 1;}}"],
    ["class declaration", "class S {string g; num f() {return 1;}}"],
    ...
    [
        "nested structs",
        "struct T{y;} struct S{z;} now x: S=S(T(1)); prnum(x.z.y);",
    ],
    ...
    [
        ...
        "num f([[num]] x) {yeet 1;} prnum(f([[1],[2]]));",
    ],
    [
        "function yeet types",
...
const semanticErrors = [
    ...
    [
        "Non-type in yeet type",
        "let x=1;function f():x{yeet 1;}",
        /Type expected/,
    ],
