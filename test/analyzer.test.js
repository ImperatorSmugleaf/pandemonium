...
const semanticChecks = [
    ...
    ["list length", "print([1,2,3].length());"],
    ...
    ["list of struct", "struct S{x;} now x:[S]=[S(), S()];"],
    [
...
/* const semanticErrors = [
  ...
  ["assign bad list type", "now x: num = 1;x=[true];", /Cannot assign a \[boolean\] to a num/],
  ...
  ["non-list in for", "for i in 100 {}", /Array expected/],
  ...
  ["diff type list elements", "print([3, true]);", /Not all elements have the same type/],
